...
class CBSEPaperPage extends StatelessWidget {
  const CBSEPaperPage({Key key, this.ncertBooks}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        TextSpan(text: " - CBSE Paper", style: TextStyle(fontSize: 18)),
      ]))),
